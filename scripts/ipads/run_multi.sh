...
function zipf_graph {
	...
	scripts/ipads/zipf_graph.py $exp_name -s $shards -u $cpu --zipf 0.0 0.3 0.5 0.6 0.7 0.8 0.9 1.0 -c 27 -d $duration -f config/client_closed.yml config/tpca_zipf.yml config/tapir.yml /tmp/concurrent.yml -dc $datacenters
...
function zipf_graph_open {
	...
	scripts/ipads/zipf_graph.py $exp_name -s $shards -u $cpu -c 9 -d $duration -f config/client_open.yml config/tpca_zipf.yml config/tapir.yml /tmp/concurrent.yml -cl 1111 -dc $datacenters
	new_experiment $exp_name
}

function rw_fixed {
	exp_name=${prefix}_rw_fixed
	./run_all.py -g -hh config/hosts-ipads.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/rw_fixed.yml -cc config/tpl_ww_paxos.yml -b rw_benchmark -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -s 1 -u 1 -r 3 -d $duration $exp_name -dc $datacenters
	new_experiment $exp_name
}

function rw {
	exp_name=${prefix}_rw
	./run_all.py -g -hh config/hosts-ipads.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/rw.yml -cc config/tpl_ww_paxos.yml -b rw_benchmark -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -s 1 -u 1 -r 3 -d $duration $exp_name -dc $datacenters
	new_experiment $exp_name
}
...
function tpca_fixed {
	...
	./run_all.py -g -hh config/hosts-ipads.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/tpca_fixed.yml -cc config/tapir.yml -b tpca -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -c 64 -c 72 -c 80 -s $shards -u $cpu -r 3 -d $duration $exp_name -dc $datacenters
	new_experiment $exp_name
}
...
function zipfs {
	...
	do
		...
		./run_all.py -g -hh config/hosts-ipads.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/tpca_zipf.yml -cc config/tapir.yml -b tpca -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -z $zipf -s 6 -u 2 -r 3 -d $duration $exp_name -dc $datacenters
		new_experiment $exp_name
	done
}
